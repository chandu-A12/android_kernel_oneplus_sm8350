...
__maybe_unused static int __init oplus_short_c_switch_status_init(char *str)
{
...
__maybe_unused static int __init oplus_short_c_feature_sw_status_init(char *str)
{
...
__maybe_unused static int __init oplus_short_c_feature_hw_status_init(char *str)
{
